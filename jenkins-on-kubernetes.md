...
[nholuongut/kubernetes-configs](https://github.com/nholuongut/kubernetes-configs#jenkins-on-kubernetes)
...
[nholuongut/kubernetes-configs - cloudbees/ directory](https://github.com/nholuongut/kubernetes-configs/tree/master/cloudbees)
...
Pod Templates
  -> Add Pod Template
    -> copy pod template from k8s repo jenkins agent-pod.yaml (https://github.com/nholuongut/kubernetes-configs/blob/master/jenkins/base/agent-pod.yaml)
...
You first need to have been using a [resizeable disk](https://github.com/nholuongut/kubernetes-configs/blob/master/jenkins/base/storageclass-gcp-standard-resizeable.yaml) configuration.
...
which requires
[Groovy Console Scripting](https://github.com/nholuongut/devops-bash-tools/blob/master/jenkins/jenkins_clear_build_history_all_jobs.groovy)
to fix it).
...
[server.yaml](https://github.com/nholuongut/kubernetes-configs/blob/master/jenkins/base/server.yaml)
or [values.yaml](https://github.com/nholuongut/kubernetes-configs/blob/master/jenkins/base/values.yaml)
