...
[nholuongut/HAProxy-configs](https://github.com/nholuongut/HAProxy-configs)
...
<https://github.com/nholuongut/HAProxy-configs/blob/master/10-global.cfg>

## Stats

<https://github.com/nholuongut/HAProxy-configs/blob/master/20-stats.cfg>
...
stats socket    /var/run/haproxy.sock uid nho group mygroup mode 0600 level admin # socat /var/run/haproxy.sock
...
```haproxy
userlist myUserList
user nho insecure-password test # groups group1,group2
user nho2 password <hash> # big performance hit
group group1 users nho,nho2
```
...
email-alert to      nho@domain.com
email-alert from    nho@domain.com
```
