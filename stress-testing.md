...
[nholuongut/templates - k6.js](https://github.com/nholuongut/templates/blob/master/k6.js)

```shell
wget -nc https://raw.githubusercontent.com/nholuongut/templates/master/k6.js
```
