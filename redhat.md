...
```shell
rpmbuild -D "packager nho nho <nho.nho@gmail.com>" foo.spec
```

```shell
cd
mkdir -p redhat/{SRPMS,RPMS,SPECS,BUILD,SOURCES}
echo "%_topdir /home/nho/redhat" >> .rpmmacros
echo "%packager nho nho <nho.nho@gmail.com>" >> .rpmmacros
then rpmbuild
```
...
```shell
cpan2rpm --no-sign --packager "nho nho <nho.nho@gmail.com>" MIME::Lite
```
...
wget -nc https://raw.githubusercontent.com/nholuongut/templates/master/anaconda-ks.cfg &&
...
[nholuongut/templates - anaconda-ks.cfg](https://github.com/nholuongut/templates/blob/master/anaconda-ks.cfg)
...
[nholuongut/Packer-templates - installers/anaconda-ks.cfg](https://github.com/nholuongut/Packer-templates/blob/master/installers/anaconda-ks.cfg)

[nholuongut/Packer-templates - fedora-x86_64.vbox.pkr.hcl](https://github.com/nholuongut/Packer-templates/blob/master/fedora-x86_64.vbox.pkr.hcl)

[nholuongut/Packer-templates - rocky-x86_64.vbox.pkr.hcl](https://github.com/nholuongut/Packer-templates/blob/master/rocky-x86_64.vbox.pkr.hcl)
