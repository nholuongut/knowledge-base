...
[nholuongut/devops-bash-tools](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment)
...
[jenkins_cli.sh](https://github.com/nholuongut/devops-bash-tools/blob/master/jenkins/jenkins_cli.sh)
...
[nholuongut/devops-bash-tools](https://github.com/nholuongut/devops-bash-tools/tree/master/jenkins)
`jenkins/` directory.
...
[nholuongut/Kubernetes - jenkins/base/values.yaml](https://github.com/nholuongut/kubernetes-configs/blob/54ad50efc573f7a69b36be1bd504d0e214fa73b5/jenkins/base/values.yaml#L136)
...
[jenkinsJobsDownloadConfigurations.groovy](https://github.com/nholuongut/Jenkins/blob/master/vars/jenkinsJobsDownloadConfigurations.groovy)

or script it yourself by calling one of these scripts and then Git committing the downloaded XMLs:

[jenkins_jobs_download_configs.sh](https://github.com/nholuongut/devops-bash-tools/blob/master/jenkins/jenkins_jobs_download_configs.sh)

[jenkins_jobs_download_configs_cli.sh](https://github.com/nholuongut/devops-bash-tools/blob/master/jenkins/jenkins_jobs_download_configs_cli.sh)
...
[here](https://github.com/nholuongut/devops-bash-tools/tree/master/jenkins).

## Jenkins Shared Libraries (Groovy)

[nholuongut/Jenkins](https://github.com/nholuongut/Jenkins) repo.
...
See [jenkins_api.sh](https://github.com/nholuongut/devops-bash-tools/blob/master/jenkins/jenkins_api.sh)
...
- Uses [docker-compose/jenkins.yml](https://github.com/nholuongut/devops-bash-tools/blob/master/docker-compose/jenkins.yml)
