...
See the [nholuongut/Terraform](https://github.com/nholuongut/Terraform) repo for some Terraform code and templates
...
[terraform_gcs_backend_version.sh](https://github.com/nholuongut/devops-bash-tools/blob/master/terraform/terraform_gcs_backend_version.sh)
