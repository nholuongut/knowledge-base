...
Various GitLab CLI scripts are in [nholuongut/devops-bash-tools](https://github.com/nholuongut/devops-bash-tools) repo.
...
[DevOps-Bash-tools](https://github.com/nholuongut/devops-bash-tools) repo, create a Personal Access Token here:
...
[.gitlab-ci.yml](https://github.com/nholuongut/templates/blob/master/.gitlab-ci.yml)
