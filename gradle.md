...
mainClassName = 'com.linkedin.nholuongut.Main'
```
...
See [nholuongut/lib-java](https://github.com/nholuongut/lib-java):
...
```properties
rootProject.name = 'nholuongut-utils'
```

[nholuongut/templates - build.gradle](https://github.com/nholuongut/templates/blob/master/build.gradle)
