...
[nholuongut/GitHub Actions - checkov.yaml](https://github.com/nholuongut/GitHub-Actions/blob/master/.github/workflows/checkov.yaml) - GitHub Actions reusable workflow imported to my repos
