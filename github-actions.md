...
- 50,000 build minutes per month for cloud enterprise Orgs (essentially free - better than paying for [CircleCI](circleci.md)!)
  - optional self-hosted runners - [nholuongut/kubernetes-configs - github-actions](https://github.com/nholuongut/kubernetes-configs/blob/master/github-actions)
- Good Integrations:
  ...
  - Code Scanning via Sarif file uploads to the Security Tabs of a repo (see
    [nholuongut/GitHub-Actions](https://github.com/nholuongut/GitHub-Actions))
...
- can't compose environment variables from other environment variables (must use step action workaround, see [nholuongut/GitHub-Actions main.yaml template](https://github.com/nholuongut/GitHub-Actions/blob/master/main.yaml))
...
eg. [nholuongut/GitHub-Actions](https://github.com/nholuongut/GitHub-Actions) -
specifically the
[main.yaml](https://github.com/nholuongut/GitHub-Actions/blob/master/main.yaml) template
and the [.github/workflows/*.yaml](https://github.com/nholuongut/GitHub-Actions/tree/master/.github/workflows).
...
Taken from [nholuongut/GitHub-Actions](https://github.com/nholuongut/GitHub-Actions) -
[main.yaml](https://github.com/nholuongut/GitHub-Actions/blob/master/main.yaml) template and
[.github/workflows/*.yaml](https://github.com/nholuongut/GitHub-Actions/tree/master/.github/workflows):
...
[github_actions_cicd.py](https://github.com/nholuongut/Diagrams-as-Code/blob/master/github_actions_cicd.py):

![GitHub Actions CI/CD](https://github.com/nholuongut/Diagrams-as-Code/raw/master/images/github_actions_cicd.png)

### GitHub Actions CI/CD to auto-(re)generate diagrams from code changes (D2lang)

Open [Diagrams-as-Code README.md](https://github.com/nholuongut/Diagrams-as-Code/blob/master/README.md#this-repos-creation--github-actions-cicd-to-auto-regenerate-diagrams-from-code-changes) to enlarge:

[github_actions_cicd.d2](https://github.com/nholuongut/Diagrams-as-Code/blob/master/github_actions_cicd.d2):

![GitHub Actions CI/CD](https://github.com/nholuongut/Diagrams-as-Code/raw/master/images/github_actions_cicd.svg)
