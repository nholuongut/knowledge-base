...
[checks/](https://github.com/nholuongut/devops-bash-tools/tree/master/checks)
...
[nholuongut/templates - .pre-commit-config.yaml](https://github.com/nholuongut/templates/blob/master/.pre-commit-config.yaml)

```shell
wget https://github.com/nholuongut/templates/blob/master/.pre-commit-config.yaml
```
