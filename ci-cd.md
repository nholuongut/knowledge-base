...
[GitHub repos](https://github.com/nholuongut?tab=repositories&q=&type=&language=&sort=stargazers)
...
- [nholuongut/Jenkins](https://github.com/nholuongut/Jenkins) - advanced `Jenkinsfile` master template and Groovy Shared Library of functions and pipelines
- [nholuongut/devops-bash-tools `jenkins/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=nholuongut&repo=TeamCity-CI&theme=ambient_gradient&description_lines_count=3)](https://github.com/nholuongut/TeamCity-CI)
...
- [nholuongut/templates - .concourse.yml](https://github.com/nholuongut/templates/blob/master/.concourse.yml)
- [nholuongut/devops-bash-tools `cicd/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- [nholuongut/templates - .gocd.yml](https://github.com/nholuongut/templates/blob/master/.gocd.yml)
- [nholuongut/devops-bash-tools `cicd/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- self-hosted [runners](https://github.com/nholuongut/kubernetes-configs/tree/master/github-actions) can be run on Kubernetes for Cloud hosted version
- [nholuongut/GitHub-Actions](https://github.com/nholuongut/GitHub-Actions) - library of parameterized reusable workflows and master templates for workflows and actions
- [nholuongut/devops-bash-tools `github/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- [nholuongut/templates - .gitlab-ci.yml](https://github.com/nholuongut/templates/blob/master/.gitlab-ci.yml)
- [nholuongut/devops-bash-tools `gitlab/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- [nholuongut/templates - azure-pipelines.yml](https://github.com/nholuongut/templates/blob/master/azure-pipelines.yml)
- [nholuongut/templates - azure-pipeline-template.yml](https://github.com/nholuongut/templates/blob/master/azure-pipeline-template.yml)
- [nholuongut/devops-bash-tools `azure_devops/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- [nholuongut/templates - bitbucket-pipelines.yml](https://github.com/nholuongut/templates/blob/master/bitbucket-pipelines.yml)
- [nholuongut/devops-bash-tools `bitbucket/`](https://github.com/nholuongut/devops-bash-tools#git---github-gitlab-bitbucket-azure-devops) -
...
- [nholuongut/templates- AWS CodeBuild buildspec.yaml](https://github.com/nholuongut/templates/blob/master/buildspec.yml)
...
- [nholuongut/templates - cloudbuild.yaml](https://github.com/nholuongut/templates/blob/master/cloudbuild.yaml) and [cloudbuild-golang.yaml](https://github.com/nholuongut/templates/blob/master/cloudbuild-golang.yaml)
...
- self-hosted [runners](https://github.com/nholuongut/kubernetes-configs/tree/master/circleci) can be run on Kubernetes
- legacy enterprise licensing model requires up front yearly usage estimation
- very expensive compared to GitHub Actions
- [nholuongut/templates - .circleci/config](https://github.com/nholuongut/templates/blob/master/circleci-config.yml)
- [nholuongut/devops-bash-tools `circleci/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- used to be free for open source on travis-ci.org which has been shut down
  ...
  - [nholuongut/templates - .travis-ci.yml](https://github.com/nholuongut/templates/blob/master/.travis.yml)
  - Real world usage example -
    [nholuongut/devops-bash-tools .travis-ci.yml](https://github.com/nholuongut/devops-bash-tools/blob/master/travis/.travis.yml)
...
- [nholuongut/devops-bash-tools `buildkite/`](https://github.com/nholuongut/devops-bash-tools#cicd---continuous-integration--continuous-deployment) -
...
- [nholuongut/templates .appveyor.yml](https://github.com/nholuongut/templates/blob/master/.appveyor.yml)
- [nholuongut/devops-bash-tools `appveyor/`](https://github.com/nholuongut/devops-bash-tools/tree/master/appveyor) -
...
- [nholuongut/templates .cirrus.yml](https://github.com/nholuongut/templates/blob/master/.cirrus.yml)
...
- [nholuongut/templates codefresh.yml](https://github.com/nholuongut/templates/blob/master/codefresh.yml)
...
- [nholuongut/templates - drone.yml](https://github.com/nholuongut/templates/blob/master/.drone.yml)
- [nholuongut/devops-bash-tools drone/](https://github.com/nholuongut/devops-bash-tools/tree/master/drone) -
...
- [nholuongut/templates - semaphore.yml](https://github.com/nholuongut/templates/blob/master/semaphore.yml)
...
Advanced library usage such as in [nholuongut/GitHub-Actions](https://github.com/nholuongut/GitHub-Actions) and
[nholuongut/Jenkins](https://github.com/nholuongut/Jenkins) sacrifice some of this portability in exchange for advanced
