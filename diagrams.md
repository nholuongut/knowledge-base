...
[nholuongut/Diagrams-as-Code](https://github.com/nholuongut/Diagrams-as-Code) - ready made architecture diagrams
...
[Templates](https://github.com/nholuongut/templates) for D2 language and Python diagrams are found here, especially
[diagram.d2](https://github.com/nholuongut/templates/blob/master/diagram.d2) and
[diagram.py](https://github.com/nholuongut/templates/blob/master/diagram.py).
...
- [D2 lang](https://d2lang.com/) - excellent, easy to use DSL for Cloud & Architecture diagrams, my favourite
  ...
  - See thse D2 [Code](https://github.com/search?q=repo%3Anholuongut%2FDiagrams-as-Code+path%3A*.d2&type=code) files
- [Python Diagrams](https://diagrams.mingrammer.com/) - my prior favourite
  - good for basic Cloud & Architecture diagrams with icons
  - See thse Python Diagrams [Code](https://github.com/search?q=repo%3Anholuongut%2FDiagrams-as-Code+path%3A*.py&type=code) files
...
- [GNUplot](http://www.gnuplot.info/) - classic code diagram CLI tool that can plot from data files in different formats
  ...
  - See these GNUplot [Code](https://github.com/search?q=repo%3Anholuongut%2FDiagrams-as-Code+path%3A*.gnuplot&type=code) files
...
- [MarkMap](https://github.com/markmap/markmap) - visualize your Markdown as mindmaps, nice, can open your GitHub repo's
  ...
  [map](https://markmap.js.org/repl#?d=github%3Anholuongut%2FDevOps-Bash-tools%40master%3AREADME.md)
...
in [nholuongut/templates](https://github.com/nholuongut/templates)
...
[nholuongut/devops-bash-tools - imageopen.sh](https://github.com/nholuongut/devops-bash-tools/blob/master/bin/imageopen.sh)
...
[nholuongut/Diagrams-as-Code](https://github.com/nholuongut/Diagrams-as-Code/Diagrams-as-Code) repo.
