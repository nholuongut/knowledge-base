...
[nholuongut/Nagios-Plugin-Kafka - build.sbt](https://github.com/nholuongut/Nagios-Plugin-Kafka/blob/master/build.sbt)

[nholuongut/lib-java - build.sbt](https://github.com/nholuongut/lib-java/blob/master/build.sbt)

[nholuongut/templates - build.sbt](https://github.com/nholuongut/templates/blob/master/build.sbt)

```shell
wget -nc https://raw.githubusercontent.com/nholuongut/templates/master/build.sbt
```
...
```batch
setx SBT_OPTS "-Dsbt.global.base=C:/Users/nho/.sbt/0.13/ -Dsbt.ivy.home=C:/Quarantine/ivy-cache/ -Dsbt.boot.directory=C:/Quarantine/sbt/boot/ -Dsbt.override.build.repos=true -Dsbt.repository.config=C:/Users/nho/.sbt/repositories"
setx SBT_CREDENTIALS "C:/Users/nho/.sbt/.credentials"
```
